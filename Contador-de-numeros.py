...
# Unir todos los documentos en un solo texto separado por comas.
...
# Iterar a través de las palabras ordenadas e imprimirlas junto con su frecuencia.
for palabra, conteo in palabras_ordenadas:
